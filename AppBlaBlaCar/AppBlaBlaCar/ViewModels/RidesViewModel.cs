...
namespace AppBlaBlaCar.ViewModels
{
    public class RidesViewModel : BaseViewModel
    {
        ...
        //CREAMOS LAS VARIABLES PARA GUARDAR EL USUARIO LOGEADO
        UserModel actualUser;
        int actualUserID;

        //CREAMOS NUESTROS COMANDO QUE SE UTILIZARAN HACIENDO REFERENCIA A SUS METODOS
        ...
        //METODO PARA INVOCAR AL DETAILVIEW Y VER LA INFORMACIÓN DEL VIAJE
        ...
        //METODO PARA INVOCAR AL USER DETIL VIEW Y VER LA INFORMACIÓN DEL USUARIO
        private void UserAction()
        {
            Application.Current.MainPage.Navigation.PushAsync(new UserDetailView(actualUser));
        }

        //REGRESA A LA PAGINA PRINCIPAL DEL LOGIN
